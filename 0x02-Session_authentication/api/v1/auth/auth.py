...
class Auth:
    ...
    This class provides methods to determine if authentication is required for a given path,
    retrieve authorization headers from requests, and handle session cookies.
    """
